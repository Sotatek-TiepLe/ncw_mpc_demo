...
import { TAsyncActionStatus, TFireblocksNCWStatus, TSetupStatus } from "./AppStore";
import {
  IAssetAddress,
  IAssetBalance,
...
export interface IAppState {
  ...
  devices: Array<{deviceId: string, walletIds: string[] }> ;
  ...
  initAppStore: () => void;
  setSetupStatus: (stt: TSetupStatus) => void;
  ...
  addDevices: (deviceId: string) => void;
  setWalletId: (walletId: string) => void;
  loginToDemoAppServer: () => Promise<void>;
